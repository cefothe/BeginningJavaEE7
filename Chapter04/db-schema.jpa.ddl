...
create table Book (id bigint generated by default as identity, description varchar(2000), illustrations boolean, isbn varchar(255), nbOfPage integer, price float, title varchar(255) not null, primary key (id))
